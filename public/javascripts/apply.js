document.querySelector("#files").addEventListener("change", (e) => {
  ...
  `;
  orderList.innerHTML = `
  <li>Proficiency in social media platforms (Facebook, Twitter, Instagram, portfolio_LinkedIn)</li>
  ...
  document.getElementById('portfolio_link_error').innerText = '';
  ...
  if (portfolio_link === "") {
    document.getElementById('portfolio_link_error').innerText = 'Please enter your portfolio portfolio_link.';
    event.preventDefault();
    return false;
  }
  ...
  // document.forms.RegForm.addEventListener('submit', handleSubmit);